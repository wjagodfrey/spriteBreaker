...
(function() {
  var app, backgroundTile, drawBackgroundTiles, fakeImageData, fileSelect, frame, imagedata, img, imgResizeFactor, jsonoutput, navigatorCanvas, navigatorCursor, navigatorMouseCoords, navigatorSelection, reset, selectorCanvas, selectorMouseCoords, tileImg, tileSource, zoomSpeed;
  ...
  app.controller('appCtrl', [
    '$scope', function(scope) {
      ...
      selectorCq = cq(selectorCanvas[0]).framework({
        ...
        onmouseon: function(x, y) {
          return console.log('over');
        },
        onrender: function(delta, time) {
          this.context.mozImageSmoothingEnabled = this.context.webkitImageSmoothingEnabled = this.context.msImageSmoothingEnabled = this.context.imageSmoothingEnabled = false;
          this.clear();
          drawBackgroundTiles(this, navigatorSelection.zoom || 1);
          if (navigatorSelection.zoom != null) {
