...
(function() {
  ...
  app.controller('appCtrl', [
    '$scope', '$timeout', '$interval', function(scope, $timeout, $interval) {
      ...
      INIT
       */
      var horizontalEdgeAdjustment, navigatorCq, save, selectorCq, spritesheetID, verticalEdgeAdjustment;
      ...
      scope.loadModalCtrl = [
        '$scope', function(scope) {
          ...
          return scope.load = function(id) {
            ...
            return scope.$parent.$parent.$parent.loadOpen = false;
          };
        }
      ];
